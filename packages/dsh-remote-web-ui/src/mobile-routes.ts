...
/** Canonicalize the old /m route while retaining pair and workspace query parameters. */function redirectToMobileRoot(req: IncomingMessage, res: ServerResponse): void {
